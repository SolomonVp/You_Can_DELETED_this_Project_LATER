...
public class AddNoteActivity extends AppCompatActivity {
    ...
    private Spinner spinnerFaysOfWeek;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerFaysOfWeek = findViewById(R.id.spinnerDaysOfWeek);
    ...
    public void onClickSaveNote(View view) {
        ...
        int dayOfWeek = spinnerFaysOfWeek.getSelectedItemPosition();
